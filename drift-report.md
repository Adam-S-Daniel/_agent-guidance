...
> Last generated: 2026-08-22 06:39 UTC
...
| [`Adam-S-Daniel/GHA-bench`](https://github.com/Adam-S-Daniel/GHA-bench) | **drift-detected** | no | bridge-ok | ok | none | none | lock: agentskills@df11631 |
| [`Adam-S-Daniel/adamdaniel.ai`](https://github.com/Adam-S-Daniel/adamdaniel.ai) | **drift-detected** | no | bridge-ok | ok | none | none | lock: agentskills@df11631 + cms-platform@633b865 |
| [`Adam-S-Daniel/agentskills`](https://github.com/Adam-S-Daniel/agentskills) | **drift-detected** | yes | bridge-ok | — | none | none |  |
| [`Adam-S-Daniel/agentskills-private`](https://github.com/Adam-S-Daniel/agentskills-private) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@94cdcc8 |
| [`Adam-S-Daniel/claude-memory-map`](https://github.com/Adam-S-Daniel/claude-memory-map) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@df11631 |
| [`Adam-S-Daniel/cms-platform`](https://github.com/Adam-S-Daniel/cms-platform) | **drift-detected** | no | bridge-ok | ok | none | none | lock: agentskills@df11631 |
| [`Adam-S-Daniel/fastmail-actions`](https://github.com/Adam-S-Daniel/fastmail-actions) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@df11631 |
| [`Adam-S-Daniel/jc`](https://github.com/Adam-S-Daniel/jc) | **drift-detected** | yes | bridge-ok | — | none | none |  |
| [`Adam-S-Daniel/repo-settings`](https://github.com/Adam-S-Daniel/repo-settings) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@94cdcc8 |
...
| [`Adam-S-Daniel/wsl-automation`](https://github.com/Adam-S-Daniel/wsl-automation) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@df11631 |
...
| Repository | Status | Has marker | CLAUDE.md bridge | skills-bootstrap | Open PR | Sections | Notes |
|------------|--------|------------|-------------------|------------------|---------|----------|-------|
| [`jodidaniel/jodidaniel.com`](https://github.com/jodidaniel/jodidaniel.com) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@df11631 + cms-platform@633b865 |
| [`jodidaniel/scratch-claude-002`](https://github.com/jodidaniel/scratch-claude-002) | **drift-detected** | yes | bridge-ok | ok | none | none | lock: agentskills@94cdcc8 |
