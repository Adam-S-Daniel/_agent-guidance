...
> Last generated: 2026-09-26 10:56 UTC

## Adam-S-Daniel

> Organization: `Adam-S-Daniel` — 16 repo(s) scanned
...
| [`Adam-S-Daniel/GHA-bench`](https://github.com/Adam-S-Daniel/GHA-bench) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
| [`Adam-S-Daniel/adam-agentskills`](https://github.com/Adam-S-Daniel/adam-agentskills) | **up-to-date** | yes | bridge-ok | — | none | none |  |
| [`Adam-S-Daniel/adam-agentskills-private`](https://github.com/Adam-S-Daniel/adam-agentskills-private) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
| [`Adam-S-Daniel/adamdaniel.ai`](https://github.com/Adam-S-Daniel/adamdaniel.ai) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d + cms-platform@3cfac16 |
| [`Adam-S-Daniel/agentskills`](https://github.com/Adam-S-Daniel/agentskills) | **up-to-date** | yes | bridge-ok | **unmanaged** | none | none |  |
| [`Adam-S-Daniel/claude-memory-map`](https://github.com/Adam-S-Daniel/claude-memory-map) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
| [`Adam-S-Daniel/cms-platform`](https://github.com/Adam-S-Daniel/cms-platform) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
| [`Adam-S-Daniel/fastmail-actions`](https://github.com/Adam-S-Daniel/fastmail-actions) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
| [`Adam-S-Daniel/jc`](https://github.com/Adam-S-Daniel/jc) | **up-to-date** | yes | bridge-ok | — | none | none |  |
| [`Adam-S-Daniel/repo-settings`](https://github.com/Adam-S-Daniel/repo-settings) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
...
| [`Adam-S-Daniel/wsl-automation`](https://github.com/Adam-S-Daniel/wsl-automation) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
...
| Repository | Status | Has marker | CLAUDE.md bridge | skills-bootstrap | Open PR | Sections | Notes |
|------------|--------|------------|-------------------|------------------|---------|----------|-------|
| [`jodidaniel/jodidaniel.com`](https://github.com/jodidaniel/jodidaniel.com) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d + cms-platform@3cfac16 |
| [`jodidaniel/scratch-claude-002`](https://github.com/jodidaniel/scratch-claude-002) | **up-to-date** | yes | bridge-ok | ok | none | none | lock: adam-agentskills@def7d1d |
...
A `codex-truncated:` clause in **Notes** means that repo's AGENTS.md is
larger than Codex's `project_doc_max_bytes` (default 32768 bytes,
codex-cli 0.154.0). Codex cuts the file at that byte and says nothing a
session can see — measured 2026-09-14, a 55,788-byte AGENTS.md rendered
through `codex debug prompt-input` as exactly 32,768 bytes, ending
mid-heading. Claude Code reads the whole file and is unaffected, so this
is a note and never a status: the managed half is held under budget by
this repo's tests, the overflow is in `## Repo-specific additions`, and
only that repo can trim it. The sync warns and syncs anyway. See
